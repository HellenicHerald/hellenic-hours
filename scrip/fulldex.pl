...
# fulldex.pl - Invoked by the main page of the Hellenic Hours - assures that all the individual pages are generated, and outputs the references to them for the main page.
...
while ( $vari_counto < ( $vari_maxo - 0.5 ) )
{
  ...
  system("liturgscr-gener -scf scrip/daily-h01.skd -date " . $lc_tdate[0] . ' ' . $lc_tdate[1] . ' ' . $lc_tdate[2] . " > \${X_DESTIN_DIR}/pz-" . $lc_daycod . "-h01.html");
  
  system("liturgscr-gener -scf scrip/daily-h02.skd -date " . $lc_tdate[0] . ' ' . $lc_tdate[1] . ' ' . $lc_tdate[2] . " > \${X_DESTIN_DIR}/pz-" . $lc_daycod . "-h02.html");
  ...
  system("liturgscr-gener -scf scrip/daily-h06.skd -date " . $lc_tdate[0] . ' ' . $lc_tdate[1] . ' ' . $lc_tdate[2] . " > \${X_DESTIN_DIR}/pz-" . $lc_daycod . "-h06.html");
